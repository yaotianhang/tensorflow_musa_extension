...
template <typename T>
__global__ void DivNoNanKernel(const T* x, DivNoNanStrides x_st, const T* y,
                               DivNoNanStrides y_st, T* out, DivNoNanDims dims,
                               int n_total) {
...
template void LaunchDivNoNan<float>(const float*, const float*, float*,
                                    DivNoNanStrides, DivNoNanStrides,
                                    DivNoNanDims, int, musaStream_t);
template void LaunchDivNoNan<double>(const double*, const double*, double*,
                                     DivNoNanStrides, DivNoNanStrides,
                                     DivNoNanDims, int, musaStream_t);
